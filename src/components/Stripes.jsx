...
const Stripes = () => {
  ...
  return (
    <div className='hidden  lg:flex h-fit  flex-wrap justify-center items-center bg-white opacity-80 border-t-2 border-b-2 border-zinc-900 py-1  mt-28 lg:mt-28'>
      {data.map((elem, index) => (
