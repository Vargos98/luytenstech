  ...
  return (
    <>
      ...
      <div className='hidden lg:block w-full h-screen bg-zinc-900 max-w-screen-xl mx-auto py-40'>
        <h1 className={`text-[12vw] xl:text-[5vw] leading-none text-nowrap -mt-20 lg:mb-20 tracking-tight transition-all duration-[1500ms] ${animateText ? 'translate-x-[2%] translate-y-[-30%] opacity-100' : 'translate-x-[-36%] opacity-0'}`}>
          Who <span className='text-orange-500 font-sans font-semibold'>we</span> are ?
        </h1>
        <div className='flex gap-2'>
          <div className='w-[65%] bg-purple-800 h-[70vh] rounded-2xl hover:bg-violet-700 hover:scale-105 transition-all duration-300 ease-in-out'>
      ...
      <div className=' lg:hidden w-full h-[90vh] bg-zinc-900 p-10 flex flex-col gap-2'>
        <div className='w-full h-[60%] bg-purple-800 rounded-2xl hover:bg-violet-700 hover:scale-105 transition-all duration-300 ease-in-out'>
        ...
        <div className='w-full h-[40%] bg-zinc-700 rounded-2xl hover:bg-orange-600 hover:scale-105 transition-all duration-300 ease-in-out hover:text-zinc-900'>
          <h1 className='text-[5.5vw] text-wrap p-4 text-zinc-100 font-semibold tracking-tighter '>
            Why Choose <span className='text-blue-400'>us</span>?
          </h1>
          <div className='w-[90%] h-72'>
            <div className='text-[3.5vw] ml-5 tracking-tight font-semibold'>
              <p>1. Vast Talent Pool</p>
              <p>2. Tailored Solutions</p>
              <p>3. Fast and Efficient</p>
              <p>4. Quality Candidates</p>
            ...
            <div className='w-1/2 mx-auto mt-16 text-md '>
              <Button />
            </div>
          </div>
        </div>
