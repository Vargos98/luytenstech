    ...
    <div className='w-full py-20 text-white' index={index}>
      ...
      <div className='block lg:hidden w-[90%] h-fit mx-auto py-20 text-white bg-zinc-800 rounded-xl'>
        <div className='flex flex-col w-full h-30 text-center transition-all duration-[1500ms] ease-in-out'>
          <h1 className='text-5xl capitalize font-medium mb-10 transition-all duration-[1500ms] ease-in-out underline underline-offset-4 decoration-2 opacity-80 text-nowrap'>{title}</h1>
