...
const Stripe = ({ val }) => {
  ...
  return (
    <div
      ref={ref}
      className={`min-[16.66%] px-10 py-5  border-b-[1.2px] border-zinc-700 flex justify-between items-center overflow-hidden transition-all duration-[1000ms] ease-linear transform  ${
