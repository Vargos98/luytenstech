...
const Services = () => {
  ...
  return (
    <div>
    <h1 className={`text-[12vw] xl:text-[5vw] mt-20 lg:mt-52 -mb-2 lg:mb-32 leading-none  transition-all duration-[1500ms] ${animateText ? ' xl:translate-x-[10%] translate-y-[15%] opacity-100' : 'translate-x-[-36%] opacity-0'
